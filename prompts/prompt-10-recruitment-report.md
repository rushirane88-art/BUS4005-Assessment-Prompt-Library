...
|---------|-------------|-----------------|----------------|
| v1.0 | No data input provided | AI fabricated entire pipeline — completely unusable and misleading | Reports always need real structured data as input |
| v1.1 | Added structured ATS data input and 3 report sections | Functional output; missing executive summary and status indicators | Management needs a scannable visual format for quick decisions |
